 ...
 ** 【关联事件影响（持续回合数lastUnitTime仅对timesOfUnit有效）】effectEvents：(events[Object({ 'EventName[String]': Object({ 'timesOfUnit': Number, 'timesOfUnitReplace': Boolean, 'lastUnitTime': Number}) })]) => Object
